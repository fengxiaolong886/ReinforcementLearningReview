...
class QLearning():
    ...
    def learn(self, s, a, r, s_,done):
        q_predict = self.estimator.predict(s_)
        q_target = r + self.discount * np.max(q_predict)
...
if __name__ == "__main__":
    ...
    RL = QLearning(env, estimator, actions, discount=1.0, alpha=0.5, epsilon=0.1)
    ...
    fig.savefig("./log/FA_QLearning_Mountain_CostMap.jpg")
