...
def Plot_the_result(rec):
    ...
    fig.show()
    fig.savefig("./log/MCPG_tf_CartPole_EpisodeLength.jpg")
    ...
    fig.show()
    fig.savefig("./log/MCPG_tf_CartPole_EpisodeReward.jpg")
    
    # Plot Episode per time step
    fig = plot_episode_stats2(rec)
    fig.show()
    fig.savefig("./log/MCPG_tf_CartPole_EpisodePerTimeStep.jpg")
